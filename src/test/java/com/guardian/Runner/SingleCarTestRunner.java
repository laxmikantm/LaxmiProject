...
@CucumberOptions(
        features = {"src/test/java/com/best4cust/Runner/features/SingleCarTests.feature", 
        		"src/test/java/com/best4cust/Runner/features/SingleTest.feature"},//path to the features
...
public class SingleCarTestRunner {
